...
import sylenthuntress.thermia.platform.Services;
import net.minecraft.core.registries.BuiltInRegistries;
import net.minecraft.world.item.Items;
import sylenthuntress.thermia.util.Constants;
...
public class Thermia {
    ...
    public static void init() {
        ...
        if (Services.PLATFORM.isModLoaded("thermia")) {

            Constants.LOGGER.info("Hello to thermia");
        }
    }
}